...
@section('content')
    ...
    <div class="container-fluid bg-breadcrumb"
        ...
        <div class="container text-center py-5" style="max-width: 900px;">
            <h3 class="text-white display-4 mb-4 wow fadeInDown" data-wow-delay="0.1s">{{ __('messages.quotation') }}</h3>
            <ol class="breadcrumb d-flex justify-content-center mb-0 wow fadeInDown" data-wow-delay="0.3s">
                ...
                <li class="breadcrumb-item active text-primary">{{ __('messages.quotation') }}</li>
            </ol>
        </div>
    </div>
    <!-- Header End -->
        ...
        <div class="row g-4">
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <div class="col-md-8">
                        <form action="{{ url('/quotation') }}" method="GET" class="d-flex flex-grow-1 me-3">
                    ...
                    <div class="col-md-4 text-end">
                        <a href="{{ url('/export-quotation') }}" class="btn btn-success">
