            ...
            <div class="row g-4">
                <div class="col-lg-6 col-lg-6 col-xl-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="training-item">
                        <div class="training-inner">
                            <img src="{{ asset('assets/img/pict.jpg') }}" class="img-fluid w-100 rounded" alt="Image" style="width: 100%; height: 300px;">
                        ...
                        <div class="training-content bg-secondary rounded-bottom p-4">
                            <a href="#">
                                <h4 class="text-white">Company Vision</h4>
                            </a>
                ...
                <div class="col-lg-6 col-lg-6 col-xl-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="training-item">
                        ...
                        <div class="training-content bg-secondary rounded-bottom p-4">
                            <a href="#">
                                <h4 class="text-white">Company Mission</h4>
                            </a>
                            <p class="text-white-50">Lorem ipsum dolor sit amet consectetur adipisicing elit. Autem,
                                veritatis.</p>
                        </div>
