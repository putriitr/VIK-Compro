        ...
        <div id="carouselId" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                <div class="carousel-item active">
                    <img src="{{ asset('storage/company_1.jpg') }}" class="img-fluid" alt="Image">
                ...
                <div class="carousel-item">
                    <img src="{{ asset('storage/company_2.jpg') }}" class="img-fluid" alt="Image">
                    <div class="carousel-caption">
                        <div class="text-center p-4" style="max-width: 900px;">
            ...
            <div class="row g-5">
                <div class="col-xl-5 wow fadeInLeft" data-wow-delay="0.1s">
                    <div class="bg-light rounded">
                        <img src="{{ asset('storage/company_1.jpg') }}" class="img-fluid w-100" style="margin-bottom: -7px;"
                            alt="Image">
                ...
                <div class="col-xl-7 wow fadeInRight" data-wow-delay="0.3s">
                    ...
                    <a href="" class="btn btn-primary border-secondary rounded-pill py-2 px-4 px-lg-3 mb-3 mb-md-3 mb-lg-0">More Details</a>
                </div>
            </div>
        </div>
    </div>
