<div class="sidenav-header">
    ...
    <a class="navbar-brand m-0 d-flex align-items-center"
        ...
        <img src="{{ asset('assets/img/logo-vik.png') }}" alt="Logo" class="me-2" style="width: 90px; height: auto;">
        <span class="text-secondary font-weight-bold">Virtual Inter<br>Komunika</span>
    </a>
</div>
    ...
    <ul class="navbar-nav">
        ...
        <li class="nav-item">
            <a class="nav-link" href="javascript:void(0);" onclick="toggleDropdown()">
                ...
                <span class="nav-link-text ms-1">Kelola Member</span>
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="javascript:void(0);" onclick="toggleDropdown()">
                ...
                <span class="nav-link-text ms-1">Kelola Distributor</span>
            </a>
        </li>
        ...
        <li class="nav-item">
            <a class="nav-link  " href="../pages/rtl.html">
                ...
                <span class="nav-link-text ms-1">Merek dan mitra</span>
            </a>
        </li>
        ...
        <li class="nav-item">
            <a class="nav-link  " href="../pages/profile.html">
                ...
                <span class="nav-link-text ms-1">Lokasi Pengguna</span>
            </a>
        </li>
        ...
        <li class="nav-item">
            <a class="nav-link  " href="../pages/sign-up.html">
                ...
                <span class="nav-link-text ms-1">Kategori Aktivitas</span>
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link  " href="{{ route('parameter.index')}}">
                ...
                <span class="nav-link-text ms-1">Parameter Perusahaan</span>
            </a>
        </li>
    </ul>
</div>
