 ...
 <footer class="content-footer footer bg-footer-theme">
     <div class="container-xxl d-flex flex-wrap justify-content-between py-2 flex-md-row flex-column">
         <div class="mb-2 mb-md-0">
             ...
             , made with ❤️ by
             <a href="https://themeselection.com" target="_blank" class="footer-link fw-bolder">PT Virtual Inter
                 Komunika</a>
         </div>
         <div>
             <a href="{{ route('home') }}" target="_blank" class="footer-link me-4">Beranda user</a>
         </div>
     </div>
 </footer>
 <!-- / Footer -->
