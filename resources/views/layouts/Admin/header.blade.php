...
<head>
    ...
    <title>Dashboard Admin VIK</title>

    <meta name="description" content="" />

    <link rel="icon" type="image/x-icon" href="{{ asset('assets/img/logo-vik.png') }}" />
    ...
    <link rel="stylesheet" href="{{ asset('assets/Admin/assets/vendor/libs/apex-charts/apexcharts.js') }}" />
